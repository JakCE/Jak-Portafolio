...
export class ProjectsComponent implements OnInit{
  arrayDataProjects: any = [
    {
      imgSrc: './projects_img/tno.jpeg',
      title: 'The Number One Academy',
      state: 'Active',
      description: 'Landing page developed for The Number One, a mathematics academy focused on strengthening analytical and problem-solving skills for school students. The platform presents academic programs, course information, and contact channels, providing a modern and responsive web presence to attract new students and communicate the academy’s educational value.',
      linkDemo: 'https://tno-academy.vercel.app/',
      linkRepo: '/projects',
      badgets: ['Astro', 'Tailwind CSS', 'SEO', 'ResponsiveDesign'],
    },
    {
      imgSrc: './projects_img/fluicash.jpeg',
      title: 'FluiCash ERP',
      state: 'Active',
      description: 'FluiCash is a multi-tenant ERP platform developed to manage the financial and operational processes of a chain of fuel service stations. The system includes automated bank reconciliation, payroll management, cash balancing, insurance policy tracking, and tax modules, all managed through a centralized roles and permissions architecture.',
      linkDemo: 'https://www.ghsoft.dev/',
      linkRepo: '/projects',
      badgets: ['Angular', 'NestJS', 'MySQL', 'ERP', 'MultiTenant'],
    },
    {
      imgSrc: './projects_img/botbbva.jpeg',
      title: 'BBVA Banking Automation Bot',
      state: 'Active',
      description: 'Automation system designed to extract daily banking transactions from BBVA NetCash using browser automation and scraping techniques. The bot securely logs into the banking platform, retrieves transaction tables, processes the data into structured JSON, and integrates it directly into an internal financial ERP system.',
      linkDemo: 'https://www.ghsoft.dev/',
      linkRepo: '/projects',
      badgets: ['NodeJS', 'Puppeteer', 'Python', 'Automation', 'WebScraping'],
    },
    {
      imgSrc: './projects_img/inti.jpeg',
      title: 'INTI Government System',
      state: 'Completed',
      description: 'Enterprise document management system developed for the Colombian Ministry of Commerce (MINCIT). The platform facilitates communication and regulatory document exchange between government entities and service providers, improving the efficiency of administrative processes.',
      linkDemo: 'https://cajadeherramientas.net/',
      linkRepo: '/projects',
      badgets: ['Angular', '.NET', 'MySQL', 'EnterpriseSoftware', 'Government'],
    },
    {
      ...
      linkDemo: 'https://www.dommies.pro/',
      linkRepo: '/projects',
